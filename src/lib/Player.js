!function (e, t) {
    ...
    return function (e) {
        ...
        Object.create && (i.prototype = Object.create(null), (new i).__proto__ || (o = !1)), u.prototype.eventNames = function () {
            ...
            var s, u, c = this._events[l], d = arguments.length;
            if (c.fn) {
            ...
            if (a.fn) a.fn !== t || r && !a.once || n && a.context !== n || s(this, i); else {
                for (var l = 0, u = [], c = a.length; l < c; l++) (a[l].fn !== t || r && !a[l].once || n && a[l].context !== n) && u.push(a[l]);
        ...
        ***************************************************************************** */
        ...
        var a, l, s, u, c = n(0), d = "twitch-embed";
        !function (e) {
        ...
        var p, f, y, E, _, h, m, v, A, P, g, b = function () {
        };
        !function (e) {
        ...
        var C = function (e) {
            ...
            function t(t) {
                var n = this.constructor, r = e.call(this, "Could not find the provided element: " + t) || this;
        ...
        function I(e, t) {
            var n = "https://" + t + ".twitch.tv" + "?" + S.stringify(i(i({}, e), {
                migration: !0,
                parent: R(e.parent),
        ...
        var T = {
            ...
            function t() {
                ...
                return t._embedWindow = null, t._playerState = T, window.addEventListener("message", t._handleResponses.bind(t)), t
            }
            ...
            return o(t, e), t.prototype._setWindowRef = function (e) {
                ...
                if (this._embedWindow) {
                    var n = {eventName: e, params: t, namespace: "twitch-embed-player-proxy"};
                ...
                if (this._embedWindow) {
                    var t = e.data, n = e.source === this._embedWindow, r = "twitch-embed-player-proxy" === t.namespace,
        ...
        var N = function (e) {
            function t(t, n) {
                ...
                return r._options = {}, r._target = null, r._player = new D, r._eventEmitter = null, r._iframe = null, r._forwardEmbedEvents = function (e) {
                    if (r._iframe) {
                        var t = e.data, n = e.source === r._iframe.contentWindow, o = t.namespace === d;
                    ...
                    if (!e || !e.channel && !e.video && !e.collection && !t) throw new C("A channel, video, or collection id must be provided in options")
                }(n), r._options = n, r._target = function (e) {
                    if (!e) throw new C("An element of type String or Element is required");
                    var t = "string" == typeof e ? document.getElementById(e) : e;
                    if (!t) throw new O(e);
                    if (1 !== t.nodeType) throw new C("An element of type String or Element is required");
                    return t
